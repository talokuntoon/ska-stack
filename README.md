...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create ska-stack-26a9
  fly apps create ska-stack-26a9-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ska-stack-26a9
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app ska-stack-26a9-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'ska-stack-26a9-staging' does not match app name in config file 'ska-stack-26a9'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name ska-stack-26a9-db
  fly postgres attach --app ska-stack-26a9 ska-stack-26a9-db

  fly postgres create --name ska-stack-26a9-staging-db
  fly postgres attach --app ska-stack-26a9-staging ska-stack-26a9-staging-db
  ```
